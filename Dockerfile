...
RUN mkdir -p ${GUACAMOLE_HOME_DIR}/extensions && wget -qO- ${QUALIX_S3_URL} | tar -xzf - && cp ${QUALIX_AUTH_PACK_NAME}/${QUALIX_AUTH_PACK_NAME}.jar ${GUACAMOLE_HOME_DIR}/extensions/ && rm -r ${QUALIX_AUTH_PACK_NAME}
